#!/usr/bin/env python3
# my modified copy of depthai code, as cloned from detphai opensource repo.
...
def runOpenCv():
    ...
    while True:
        ...
        # Label the red area in the image
        just_red, labeled_image = isolate_red_area(frame)

        cv2.imshow("Isolated Red Object", just_red)  # show just red objects
        cv2.imshow("Labeled Red Area", labeled_image)  # show original image with object framed and text
