...
def parseArgs():
    ...
    parser.add_argument('-guit', '--guiType', type=str, default="auto", choices=["auto", "qt", "opencv"], help="Specify GUI type of the demo. \"opencv\" uses buil-in OpenCV display methods, \"qt\" uses Qt to display interactive GUI. \"auto\" will use OpenCV for Raspberry Pi and Qt for other platforms")
