...
num_image_per_polygon = 10 # number of images captured per polygon, this value can be changed, the bigger value, the more images per each polygon will be captured
