...
parser.add_argument('-test', '--test-loop', action='store_true',
                    help="Run in a loop for multiple device testing")
            ...
            if pkt is not None:
                ...
                if cam_type_tof[c]:
                    ...
                    if args.tof_cm:
                        ...
                        frame = (frame.view(np.int16).astype(float)).reshape(shape)
