...
.. tabs::
    ...
    .. tab:: Python
        ...
        Also `available on GitHub <https://github.com/luxonis/depthai-python/blob/main/examples/mixed/rgb_encoding_mono_mobilenet.py>`__

        .. literalinclude:: ../../../../examples/mixed/SDK_rgb_encoding_mono_MBNet.py
           :language: python
           :linenos:
