...
class PreviewManager:
    ...
    def __init__(self, display=[], nnSource=None, colorMap=None, depthConfig=None, dispMultiplier=255/96, mouseTracker=False, lowBandwidth=False, scale=None, fpsHandler=None, createWindows=True):
        """
        Args:
