...
from ..constants import PortTypeEnum, PipeLayoutEnum
...
from ..widgets.dialogs import BaseDialog, FileDialog
from ..widgets.scene import NodeScene
from ..widgets.tab_search import TabSearchMenuWidget
            ...
            for check_port in getattr(check_node, io_types[end_port.port_type]):
                if check_port.connected_ports:
                    for port in check_port.connected_ports:
                        ...
                        # GX
                        if port.node != start_node and port.node not in check_nodes:
